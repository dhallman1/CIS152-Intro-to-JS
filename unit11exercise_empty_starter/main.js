...
//4a
console.log("Hello,My name is Daryl Hallman");
//4b
...
//5e
var money = (33 * 100);
var momey1 = (15.87 * 100);
var money_total = (money - momey1);
console.log("The answer is: $" + (money_total / 100));
//6a
...
//7p
console.log("The type of '0' is: " + typeof(O));
//7q
console.log("The type of '\"0\"' is: " + typeof("O"));
//7r
console.log("The type of '\"\"' is: " + typeof(""));
...
console.log("The final total is: " + total + 
           ", when the starting values are ‘foo’: " + foo + " and \'bar': " +bar );